    ...
    public sealed class ConfigurationFileReader : IConfigurationFileReader
    {
        ...
        public string GetValue(string keyName)
        {
            ...
            else
            {
                ...
                {
                    m_runningConfig = m_getConfiguration();
                }
                else
                {
                    var fileMap = new ExeConfigurationFileMap { ExeConfigFilename = ConfigName };
                    m_runningConfig = ConfigurationManager.OpenMappedExeConfiguration(
                        fileMap, ConfigurationUserLevel.None);
                }

                value = GetValueFromConfig(keyName);
#else
        ...
        {
            string value = null;
                KeyValueConfigurationElement element = m_runningConfig.AppSettings.Settings[keyName];
                if (element != null)
                {
                    value = element.Value;
                }
